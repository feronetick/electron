...
void NativeWindowMac::SetSimpleFullScreen(bool simple_fullscreen) {
  ...
  if (simple_fullscreen && !is_simple_fullscreen_) {
   ...
   // } else {
    ...
    SetStyleMask(true, NSBorderlessWindowMask);
    SetStyleMask(true, NSNonactivatingPanelMask);
    SetStyleMask(true, NSUtilityWindowMask);
    SetCollectionBehavior(true, NSWindowCollectionBehaviorCanJoinAllSpaces);
    ...
    SetStyleMask(false, NSBorderlessWindowMask);
    SetStyleMask(false, NSNonactivatingPanelMask);
    SetStyleMask(false, NSUtilityWindowMask);
    SetCollectionBehavior(false, NSWindowCollectionBehaviorCanJoinAllSpaces);
  }
}
